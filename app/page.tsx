...
const Home =()=> {
  ...
  return (
   <div className=" container_items ">
      {
        names.map((name) => (
          <Link href={name === 'مواعيد تجديد المتهمين' ? '/case/management' : '/case/add'}  className="item flex items-center  shadow-2xl cursor-pointer  " data-aos={name === 'مواعيد تجديد المتهمين' ? 'fade-right' : 'fade-left'}  data-aos-duration="3000"  key={name}>
